# Restaurant-selection-map

This is a web page used for visualization in a BDA group assignment. The repository is intended for publishing the project web page.
